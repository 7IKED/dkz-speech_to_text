...
### VoiceForge™ Speech-to-Text — Audacity-Style Stereo, Füllwort-Filter, Snippet-Manager, Meeting-Modus, Whisper API

**Part of the [DEVKiTZ™ Ecosystem](https://github.com/7IKED/devkitz-workspace)**

![Category](https://img.shields.io/badge/Category-Voice%20%26%20TTS-fa1e4e?style=for-the-badge)
![Tech](https://img.shields.io/badge/Stack-HTML5%20%7C%20JSON-00ff88?style=for-the-badge)
![Lines](https://img.shields.io/badge/Lines-1100-ffb800?style=for-the-badge)
...
```bash
# Clone
git clone https://github.com/7IKED/dkz-speech_to_text.git

# Oeffnen
cd dkz-speech_to_text
